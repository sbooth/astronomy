...
int main(int argc, const char *argv[])
{
    ...
    */
    ...
    /*
       Calculate the Moon's equator of date and horizontal coordinates.
     */
    ...
    printf("Hour angle = %0.3lf degrees.\n", moon_hour_angle.value * HOUR2RAD);
...
//    α0 = sun_equator_j2000.ra * HOUR2RAD;
    ...
    printf("Zenith angle = %0.3lf degrees.\n", moon_position_angle - moon_parallactic_angle);
